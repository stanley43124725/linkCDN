let res
  function shorturl() {
	...
	document.getElementById("searchbtn").innerHTML='<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>請稍候...';
  ...
  .then(function(myJson) {
	...
	document.getElementById("searchbtn").innerHTML=' 羅大佑噴水了';
    if(res.key!=="")
